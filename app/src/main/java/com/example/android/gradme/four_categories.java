...
public class four_categories extends AppCompatActivity {

    int prc1, prc2, prc3, prc4;
    int pts1, pts2, pts3, pts4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_four_categories);
        ...
        calculatebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int percentsum = prc1 + prc2 + prc3 + prc4;
                ...
                {
                    double grade = 0;
                    grade= prc1*pts1*0.01 + prc2*pts2*0.01 + prc3*pts3*0.01 + prc4*pts4*0.01;
