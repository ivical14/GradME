...
public class six_categories extends AppCompatActivity {

    int prc1, prc2, prc3, prc4, prc5, prc6;
    int pts1, pts2, pts3, pts4, pts5, pts6;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_six_categories);
        ...
        final EditText percentages6 = (EditText)findViewById(R.id.percentages6);
        ...
        final EditText points6 = (EditText)findViewById(R.id.points6);
        ...
        calculatebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prc6 = Integer.parseInt(String.valueOf(percentages6.getText()).replaceAll("[^\\d.]", ""));
                ...
                pts6 = Integer.parseInt(String.valueOf(points6.getText()).replaceAll("[^\\d.]", ""));

                int percentsum = prc1 + prc2 + prc3 + prc4 + prc5 + prc6;
                ...
                {
                    double grade = 0;
                    grade= prc1*pts1*0.01 + prc2*pts2*0.01 + prc3*pts3*0.01 + prc4*pts4*0.01 + prc5*pts5*0.01 + prc6*pts6*0.01;
